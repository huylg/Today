...
#ifndef TODAY_SWIFT_H
#define TODAY_SWIFT_H
...
SWIFT_CLASS("_TtC5Today11AppDelegate")
...
SWIFT_CLASS("_TtC5Today18ReminderDoneButton")
...
SWIFT_CLASS("_TtC5Today26ReminderListViewController")
@interface ReminderListViewController : UICollectionViewController
- (void)viewDidLoad;
- (BOOL)collectionView:(UICollectionView * _Nonnull)_ shouldSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
@interface ReminderListViewController (SWIFT_EXTENSION(Today))
- (void)didPressDoneButton:(ReminderDoneButton * _Nonnull)sender;
@end



SWIFT_CLASS("_TtC5Today22ReminderViewController")
...
SWIFT_CLASS("_TtC5Today13SceneDelegate")
