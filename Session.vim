...
badd +1840 ~/nvim-nightly/share/nvim/runtime/lua/vim/lsp/util.lua
...
badd +35 Today/ListViewController/ReminderListViewController+DataSource.swift
badd +5 .compile
...
badd +0 Today/Assets.xcassets/TodayListCellBackground.colorset/Contents.json
...
wincmd w
argglobal
if bufexists(fnamemodify("~/personal/Todo/Today/ListViewController/ReminderListViewController+DataSource.swift", ":p")) | buffer ~/personal/Todo/Today/ListViewController/ReminderListViewController+DataSource.swift | else | edit ~/personal/Todo/Today/ListViewController/ReminderListViewController+DataSource.swift | endif
if &buftype ==# 'terminal'
  silent file ~/personal/Todo/Today/ListViewController/ReminderListViewController+DataSource.swift
endif
balt ~/personal/Todo/Today/Models/Date+Today.swift
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
